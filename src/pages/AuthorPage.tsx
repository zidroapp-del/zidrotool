...
export default function AuthorPage() {
  ...
  const normalizeSocialUrl = (value: string, base: string) =>
    /^https?:\/\//i.test(value) ? value : `${base}${value.replace(/^\//, "")}`;

  const socialLinks = [
    author.twitter && { icon: Twitter, url: normalizeSocialUrl(author.twitter, "https://twitter.com/"), label: "Twitter" },
    author.github && { icon: Github, url: normalizeSocialUrl(author.github, "https://github.com/"), label: "GitHub" },
    author.linkedin && { icon: Linkedin, url: normalizeSocialUrl(author.linkedin, "https://linkedin.com/in/"), label: "LinkedIn" },
    author.website && { icon: Globe, url: normalizeSocialUrl(author.website, "https://"), label: "Website" },
