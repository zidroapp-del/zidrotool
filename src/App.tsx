...
const PdfMerger = safeLazy(() => import("@/tools/PdfMerger"));
const PdfSplitter = safeLazy(() => import("@/tools/PdfSplitter"));
const ImageToPdf = safeLazy(() => import("@/tools/ImageToPdf"));
const TemporaryEmail = safeLazy(() => import("@/tools/TemporaryEmail"));
...
const TrustPage = safeLazy(() => import("@/pages/TrustPage"));
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          <Route element={<Layout />}>
            ...
            <Route path="tools/10-minute-mail" element={<TemporaryEmail />} />
            <Route path="tools/temporary-email" element={<TemporaryEmail />} />
            <Route path="tools/temp-mail" element={<TemporaryEmail />} />
            <Route path="services/temporary-email" element={<TemporaryEmail />} />
            ...
            <Route path="dmca" element={<TrustPage />} />
